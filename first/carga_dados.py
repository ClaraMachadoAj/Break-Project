from firstapp.cadastros import CadastroAlbums, CadastroArtistas, CadastrosMusicas
...
def executa():
    ...
    for musica in musicas:
        CadastrosMusicas.criar(musica['Nome'], musica['Compositor'], musica['Duracao'], musica['Album_ID'])
